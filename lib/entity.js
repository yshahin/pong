(function() {
  ...
  var self = Entity = function() {
    init();
  }

  self.prototype.init = function(game) {
    // A game entity has ...
  ...
  self.prototype.xEdge = function() {
    return this.x + this.width;
  }

  self.prototype.yEdge = function() {
  ...
  self.prototype.intersect = function(other) {
